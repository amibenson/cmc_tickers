...
def format_name(obj):
    return  mark_safe('%s<br><small><a href="https://coinmarketcap.com/currencies/%s/" target=_blank>https://coinmarketcap.com/currencies/%s/</a> (<a href="https://coinmarketcap.com/currencies/%s/" target=_blank>HF</a>)</small><br>' % (obj.name, obj.name, obj.name, obj.symbol ))
